...
#define QUICK_HOME                            // If G28 contains XY do a diagonal move first  fms
...
//#define ASSISTED_TRAMMING
  ...
  // Define positions for probe points. //FMS
  #define TRAMMING_POINT_XY { {  35, 35 }, { 355,  35 }, { 355 180 }, { 35, 355 } }  //FMS
  ...
  #define REPORT_TRAMMING_MM          // Report Z deviation (mm) for each point relative to the first  fms

  #define ASSISTED_TRAMMING_WIZARD    // Add a Tramming Wizard to the LCD menu  fms

  #define ASSISTED_TRAMMING_WAIT_POSITION { X_CENTER, Y_CENTER, 30 } // Move the nozzle out of the way for adjustment  fms
 ...
 */
//#define INPUT_SHAPING_X  //fms NOT ENOUIGH MEMORY ON 8 BIT BOARD
//#define INPUT_SHAPING_Y   //fms
  ...
  //#define SHAPING_MENU                // Add a menu to the LCD to set shaping parameters.  //fms
#endif
...
//#endif
  ...
  #define STATUS_MESSAGE_SCROLLING  //FMS
...
#define SET_PROGRESS_MANUALLY  //FMS
#if ENABLED(SET_PROGRESS_MANUALLY)
  #define SET_PROGRESS_PERCENT            // Add 'P' parameter to set percentage done
  #define SET_REMAINING_TIME              // Add 'R' parameter to set remaining time
  //#define SET_INTERACTION_TIME          // Add 'C' parameter to set time until next filament change or other user interaction
  #define M73_REPORT                    // Report M73 values to host  //FMS
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define LONG_FILENAME_HOST_SUPPORT    // Get the long filename of a file/folder with 'M33 <dosname>' and list long filenames with 'M20 L'  fms
  //#define LONG_FILENAME_WRITE_SUPPORT   // Create / delete files with long filenames via M28, M30, and Binary Transfer Protocol
  //#define M20_TIMESTAMP_SUPPORT         // Include timestamps by adding the 'T' flag to M20 commands

  #define SCROLL_LONG_FILENAMES           // Scroll long filenames in the SD card menu  FMS
  ...
  #define AUTO_REPORT_SD_STATUS         // Auto-report media status with 'M27 S<seconds>'  fms btt screen
   ...
   */
  #define SDCARD_CONNECTION ONBOARD  //fms for btt screen was LCD changed to ONBOARD
 ...
 */
#define BABYSTEPPING  //FMS
#if ENABLED(BABYSTEPPING)
  //#define INTEGRATED_BABYSTEPPING         // EXPERIMENTAL integration of babystepping into the Stepper ISR
  //#define BABYSTEP_WITHOUT_HOMING
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement).  FMS
  ...
  #define BABYSTEP_DISPLAY_TOTAL          // Display total babysteps since last G28  FMS
 ...
 */
#define EMERGENCY_PARSER  //fms for btt screen
...
//#define REALTIME_REPORTING_COMMANDS
  ...
  #define FULL_REPORT_TO_HOST_FEATURE   // Auto-report the machine status like Grbl CNC fms for btt screen host_action_command
#endif
...
#define SERIAL_FLOAT_PRECISION 4  //fms for btt screen
 ...
 */
#define ADVANCED_PAUSE_FEATURE  //fms
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      750  // (mm) The length of filament for a complete unload.  fms
  ...
  #define FILAMENT_CHANGE_FAST_LOAD_LENGTH    650  // (mm) Load length of filament, from extruder gear to nozzle.  fms
                                                  //   For Bowden, the full length of the tube and nozzle.
                                                  //   For direct drive, the full length of the nozzle.
  ...
  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change.  fms
  //#define HOME_BEFORE_FILAMENT_CHANGE           // If needed, home before parking for filament change

  #define FILAMENT_LOAD_UNLOAD_GCODES           // Add M701/M702 Load/Unload G-codes, plus Load/Unload in the LCD Prepare menu.  fms
 ...
 */
  ...
  #define INTERPOLATE      true
    ...
    #define X_CURRENT       580        // (mA) RMS current. Multiply by 1.414 for peak current.  FMS
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below)  FMS
  ...
  //#define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    //#define SPI_ENDSTOPS              //#define TMC_SPI_MOSI  -1
  //#define TMC_SPI_MISO  -1
  //#define TMC_SPI_SCK   -1
...
//#define LASER_FEATURE
  ...
  //#define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX]
    ...
    */
     ...
     * More refined power control such as compensation for accell/decell will be addressed in future releases.
     *
 ...
 */
#define AUTO_REPORT_POSITION  // fms for btt screen
...
#define EXTENDED_CAPABILITIES_REPORT
  ...
  #define M115_GEOMETRY_REPORT  // fms for btt screen
#endif
...
#define M114_DETAIL         // Use 'M114` for details to check planner calculations  fms for btt screen
//#define M114_REALTIME       // Real current position based on forward kinematics
//#define M114_LEGACY         // M114 used to synchronize on every call. Enable if needed.

#define REPORT_FAN_CHANGE   // Report the new fan speed when changed by M106 (and others)  //fms for btt screen
 ...
 */
#define HOST_ACTION_COMMANDS  //fms for btt screen
#if ENABLED(HOST_ACTION_COMMANDS)
  #define HOST_PAUSE_M76                // Tell the host to pause in response to M76  fms
  #define HOST_PROMPT_SUPPORT           // Initiate host prompts to get user feedback  fms
  #if ENABLED(HOST_PROMPT_SUPPORT)
    #define HOST_STATUS_NOTIFICATIONS   // Send some status messages to the host as notifications  fms
  #endif
