 ...
 * 
 * bUGFIX 2.1.X  BUILD 18/4/2023  ******** NOT TESTED YET ****
 * 
 * ENDER 5 PLUS
 ...
 * https://github.com/bigtreetech/BIGTREETECH-TouchScreenFirmware/#connecting-the-tft-to-the-mainboard
 * https://hackaday.com/2022/01/03/tft35-dual-mode-3d-print-control-hands-on/
 * https://github.com/bigtreetech/BIGTREETECH-TFT35-V3.0
 * https://github.com/bigtreetech/BIGTREETECH-TouchScreenFirmware
 */
#pragma once

//#define CONFIG_EXAMPLES_DIR "Creality/Ender-5 Plus"  //FMS
...
#define STRING_CONFIG_H_AUTHOR "(FlixMySwitch, Ender-5Plus Extra)" // Who made the changes.  fms
...
#ifndef MOTHERBOARD
  //#define MOTHERBOARD BOARD_RAMPS_CREALITY  // fms we have a standard 8 bit creality v2.2 board
 ...
 */
#define BAUDRATE 115200  // fms we need to know this for protoface connection

#define BAUD_RATE_GCODE     // Enable G-code M575 to set the baud rate  //fms
...
#define CUSTOM_MACHINE_NAME "5 Plus Pro"  // fms
...
#define HEATER_0_MAXTEMP 255  // we only have this one, stanard mk8 ally block hotend fms
...
#define BED_MAXTEMP      90  // fms i only print pla and petg so lets reduce this
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  19.97 // fms  19.41  standard wiyh silicone sock
    #define DEFAULT_Ki   1.35  // fms 1.38
    #define DEFAULT_Kd  73.62  // fms  68.38
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 65.80  // fms  10.00
  #define DEFAULT_bedKi  4.00  // fms .023
  #define DEFAULT_bedKd 722.30  // fms 305.4
  // pid above 24v standard 5 plus bed that has been insulated
...
#define MAX_CHAMBER_POWER 255 // limits duty cycle to chamber heater; 255=full current
  ...
  #define PID_EDIT_MENU           // Add PID editing to the "Advanced Settings" menu. (~700 bytes of flash)  FMS
  #define PID_AUTOTUNE_MENU       // Add PID auto-tuning to the "Advanced Settings" menu. (~250 bytes of flash) FMS
#endif
...
#define EXTRUDE_MINTEMP 170 // fms 170
...
#define EXTRUDE_MAXLENGTH 900 // fms MY BOWDEN TUBE IS AROUND 700
...
#define USE_XMAX_PLUG  //as the 5 plus homes in back right corner
...
#define DETECT_BROKEN_ENDSTOP  //fms
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 415}// fms 93.02 as i have a bondtech																			
 ...
 */
// E steps example: steps per revolution s=200, microstepping m=16, effective gear diameter d=10.95: sm/(πd) = 93.02																																						
#define DEFAULT_MAX_FEEDRATE        { 500, 500, 5, 25 }// {3000,3000,15,15000}// fms  { 500, 500, 5, 25 }

#define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2  fms
#if ENABLED(LIMITED_MAX_FR_EDITING)
  #define MAX_FEEDRATE_EDIT_VALUES    {800,800,10,50}// fms{ 600, 600, 10, 50 } // ...or, set your own edit limits
#endif
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2  fms
#if ENABLED(LIMITED_MAX_ACCEL_EDITING)
  #define MAX_ACCEL_EDIT_VALUES       {1000,1000,200,5000}// fms{ 6000, 6000, 200, 20000 } // ...or, set your own edit limits
#endif
 ...
 */
#define DEFAULT_ACCELERATION                   2000  // X, Y, Z ... and E acceleration for printing moves  fms
#define DEFAULT_RETRACT_ACCELERATION           2000  // E acceleration for retracts  fms
#define DEFAULT_TRAVEL_ACCELERATION            2000  // X, Y, Z ... acceleration for travel (non printing) moves  fms
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.013  // (mm) Distance from real junction edge  //fms 0.013   0.15
 ...
 */
#define S_CURVE_ACCELERATION  //fms
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -19, 0}  // x,y,z  fms twin 4020 cooling duct z -2.58
...
#define PROBING_MARGIN 35  //fms so that the cooling ducts and probe pin miss the bed clips

// X and Y axis travel speed (mm/min) between probes
#define XY_PROBE_FEEDRATE (200*60)  //fms 133*60

// Feedrate (mm/min) for the first approach when double-probing (MULTIPLE_PROBING == 2)
#define Z_PROBE_FEEDRATE_FAST (12*60)  //fms 4*60
 ...
 */
#define MULTIPLE_PROBING 4 // was 2 fms as we only do this once
...
#define Z_PROBE_OFFSET_RANGE_MIN -4  //fms
#define Z_PROBE_OFFSET_RANGE_MAX 20  // fms
...
//#define PROBING_HEATERS_OFF       // Turn heaters off when probing
  ...
  #define WAIT_FOR_BED_HEATER     // Wait for bed to heat back up between probes (to improve accuracy)  fms
  #define WAIT_FOR_HOTEND         // Wait for hotend to heat back up between probes (to improve accuracy & prevent cold extrude)  fms
#endif
#define PROBING_FANS_OFF          // Turn fans off when probing  fms make sure coolong fan is off
//#define PROBING_ESTEPPERS_OFF     // Turn all extruder steppers off when probing
//#define PROBING_STEPPERS_OFF      // Turn all steppers off (unless needed to hold position) when probing (including extruders)
#define DELAY_BEFORE_PROBING 400  // (ms) To prevent vibrations from triggering piezo sensors  fms  200

// Require minimum nozzle and/or bed temperature for probing
//#define PREHEAT_BEFORE_PROBING  //fms no as we are pre heating before leveling
#if ENABLED(PREHEAT_BEFORE_PROBING)
  #define PROBING_NOZZLE_TEMP 120   // (°C) Only applies to E0 at this time  fms
  #define PROBING_BED_TEMP     55  // fms
#endif
...
#define INVERT_E0_DIR true  // fms as i have a bondtech dual gear extruder
...
#define NO_MOTION_BEFORE_HOMING // Inhibit movement until all axes have been homed. Also enable HOME_AFTER_DEACTIVATE for extra safety.  fms
#define HOME_AFTER_DEACTIVATE   // Require rehoming after steppers are deactivated. Also enable NO_MOTION_BEFORE_HOMING for extra safety.  fms
 ...
 */
#define Z_IDLE_HEIGHT Z_HOME_POS  //fms
...
#define Z_AFTER_HOMING  75     // (mm) Height to move to after homing Z  //fms so you can trim off ant filament
...
#define X_BED_SIZE 390  //fms			  
#define Y_BED_SIZE 390  //fms

// Travel limits (linear=mm, rotational=°) after homing, corresponding to endstop positions.
#define X_MIN_POS 8  // fms 8
#define Y_MIN_POS -1  // fms -1
#define Z_MIN_POS 0
...
#define MAX_SOFTWARE_ENDSTOPS
  ...
  #define SOFT_ENDSTOPS_MENU_ITEM  // Enable/Disable software endstops from the LCD  fms
#endif
 ...
 */
#define FILAMENT_RUNOUT_SENSOR // fms
...
#define PREHEAT_BEFORE_LEVELING
  ...
  #define LEVELING_NOZZLE_TEMP 120   // (°C) Only applies to E0 at this time //fms so its warm but not hot enough to drip filament
  #define LEVELING_BED_TEMP     55  // fms  the normal temp you print at
#endif
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_NOZZLE_SIZE    0.6  // (mm) Diameter of primary nozzle.  fms
  ...
  #define GRID_MAX_POINTS_X 7  //fms
  ...
  #define MESH_INSET 35              // Set Mesh bounds as an inset region of the bed  fms
  #define GRID_MAX_POINTS_X 11      // Don't use more than 15 points per axis, implementation limited.  fms
  #define GRID_MAX_POINTS_Y GRID_MAX_POINTS_X
  ...
  #define UBL_MESH_WIZARD         // Run several commands in a row to get a complete mesh  fms
...
#define LCD_BED_LEVELING
  ...
  #define MESH_EDIT_Z_STEP  0.025 // (mm) Step size while manually probing Z axis. fms
  #define LCD_PROBE_Z_RANGE 4     // (mm) Z Range centered on Z_MIN_POS for LCD Z adjustment
  #define MESH_EDIT_MENU        // Add a menu to edit mesh points
#endif

// Add a menu item to move between bed corners for manual bed adjustment
#define LCD_BED_TRAMMING    //FMS will use paper or a feeler gauge

#if ENABLED(LCD_BED_TRAMMING)
  #define BED_TRAMMING_INSET_LFRB { 10, 40, 10, 40 } // (mm) Left, Front, Right, Back insets  fms as we only have bed clips front and back
  #define BED_TRAMMING_HEIGHT      0.0        // (mm) Z height of nozzle at leveling points
  #define BED_TRAMMING_Z_HOP       4.0        // (mm) Z height of nozzle between leveling points
  //#define BED_TRAMMING_INCLUDE_CENTER       // Move to the center after the last corner  fms


  //#define BED_TRAMMING_USE_PROBE
  #if ENABLED(BED_TRAMMING_USE_PROBE)
    #define BED_TRAMMING_PROBE_TOLERANCE 0.05  // (mm)  FMS
   ...
   */
  #define BED_TRAMMING_LEVELING_ORDER {LF,RB,LB,RF}// { LF,RF,RB,LB}  //FMS
#endif
...
#define HOMING_FEEDRATE_MM_M { (60*60), (60*60), (5*60) }  //fms { (50*60), (50*60), (5*60) }
...
//
//  FMS if you add preheats below make sure to inscrease the _X_ number
//
...
#define PREHEAT_2_LABEL       "PETG"   //FMS
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 10), (Y_MAX_POS - 10), 30 }  //fms 30 above bed should be front right
 ...
 */
#define NOZZLE_CLEAN_FEATURE  //fms
  ...
  #define NOZZLE_CLEAN_START_POINT { {  30, 410, (Z_MIN_POS + 3) } }//  move outside of print bed area FMS
  #define NOZZLE_CLEAN_END_POINT   { { 70, 410, (Z_MIN_POS + 3) } }
  ...
  #define NOZZLE_CLEAN_NO_Z  //fms

  // For a purge/clean station mounted on the X axis
  //#define NOZZLE_CLEAN_NO_Y

  // Require a minimum hotend temperature for cleaning
  #define NOZZLE_CLEAN_MIN_TEMP 170  //fms
  #define NOZZLE_CLEAN_HEATUP       // Heat up the nozzle instead of skipping wipe  fms
 ...
 */
#define DISPLAY_CHARSET_HD44780 WESTERN  //fms
...
//
#define LCD_FEEDBACK_FREQUENCY_DURATION_MS 2  //fms
#define LCD_FEEDBACK_FREQUENCY_HZ 5000  //fms
...
// https://reprap.org/wiki/RepRapDiscount_Full_Graphic_Smart_Controller FMS as well are using the BTT 3.5" dual screen
//
